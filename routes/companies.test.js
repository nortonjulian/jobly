...
describe("GET /companies", function () {
  ...
  test("works: returns empty array if no matches found", async function () {
    const resp = await request(app).get("/companies").query({ name: "XYZ" });
    expect(resp.body).toEqual({
      companies: [],
    });
  });
  ...
  test("works for anon", async function () {
    ...
    expect(resp.body).toEqual({
      company: {
        ...
        numEmployees: 1,
        logoUrl: "http://c1.img",
        jobs: [ {id: expect.any(Number), title: 'Job 1', salary: 50000, equity: 0.1 } ]
      },
    });
  });
  ...
  test("works for anon: company w/o jobs", async function () {
    ...
    expect(resp.body).toEqual({
      company: {
        ...
        numEmployees: 2,
        logoUrl: "http://c2.img",
        jobs: [ {id: expect.any(Number), title: 'Job 2', salary: 60000, equity: 0.2 } ]
      },
    });
  });
